    ...
    return (
        <nav className="flex justify-between items-center py-4 px-8 bg-white">
            ...
            <div className="flex space-x-8 ml-10"> {/* Add margin-left here */}
                ...
                <Link to="/signin" className="bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transform transition-transform duration-300 hover:scale-110">
                    Sign
                </Link>
            </div>
        </nav>
